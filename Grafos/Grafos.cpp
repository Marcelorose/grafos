...
int main()
{
	...
	teste.grafoMatriz.inserirAresta(0, 1);
	teste.grafoMatriz.inserirAresta(2, 0);
	teste.grafoMatriz.inserirAresta(5, 0);
	teste.grafoMatriz.inserirAresta(3, 0);
	teste.grafoMatriz.inserirAresta(6, 0);
	//teste.grafoMatriz.imprimeGrafo();
	//cout << teste.grafoMatriz.existeAresta(0, 0);
	//cout << teste.grafoMatriz.existeAresta(0, 1);
	vector <int> temp = teste.grafoMatriz.retornarVizinhos(0);
